...
var ProviderSet = wire.NewSet(NewData, NewApplicationRepo, NewApplicantRepo, NewGreeterRepo, NewReferenceRepo, NewSurveyRepo, NewFinancialRepo, NewDecisionRepo)
