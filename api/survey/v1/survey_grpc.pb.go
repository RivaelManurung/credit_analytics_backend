...
const (
	...
	SurveyService_GetSurveyTemplate_FullMethodName        = "/api.survey.v1.SurveyService/GetSurveyTemplate"
...
type SurveyServiceClient interface {
	...
	GetSurveyTemplate(ctx context.Context, in *GetSurveyTemplateRequest, opts ...grpc.CallOption) (*SurveyTemplate, error)
	// ===== TEMPLATES (Optional Admin/Setup) =====
...
func (c *surveyServiceClient) AssignSurvey(ctx context.Context, in *AssignSurveyRequest, opts ...grpc.CallOption) (*ApplicationSurvey, error) {
	...
	err := c.cc.Invoke(ctx, SurveyService_AssignSurvey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *surveyServiceClient) GetSurvey(ctx context.Context, in *GetSurveyRequest, opts ...grpc.CallOption) (*ApplicationSurvey, error) {
	out := new(ApplicationSurvey)
	err := c.cc.Invoke(ctx, SurveyService_GetSurvey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *surveyServiceClient) ListSurveysByApplication(ctx context.Context, in *ListSurveysByApplicationRequest, opts ...grpc.CallOption) (*ListSurveysByApplicationResponse, error) {
	...
	err := c.cc.Invoke(ctx, SurveyService_ListSurveysByApplication_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *surveyServiceClient) ListSurveys(ctx context.Context, in *ListSurveysRequest, opts ...grpc.CallOption) (*ListSurveysResponse, error) {
	...
	err := c.cc.Invoke(ctx, SurveyService_ListSurveys_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *surveyServiceClient) StartSurvey(ctx context.Context, in *StartSurveyRequest, opts ...grpc.CallOption) (*ApplicationSurvey, error) {
	out := new(ApplicationSurvey)
	err := c.cc.Invoke(ctx, SurveyService_StartSurvey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *surveyServiceClient) VerifySurvey(ctx context.Context, in *VerifySurveyRequest, opts ...grpc.CallOption) (*ApplicationSurvey, error) {
	out := new(ApplicationSurvey)
	err := c.cc.Invoke(ctx, SurveyService_VerifySurvey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *surveyServiceClient) SubmitSurveyAnswer(ctx context.Context, in *SubmitSurveyAnswerRequest, opts ...grpc.CallOption) (*SurveyAnswer, error) {
	...
	err := c.cc.Invoke(ctx, SurveyService_SubmitSurveyAnswer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *surveyServiceClient) UploadSurveyEvidence(ctx context.Context, in *UploadSurveyEvidenceRequest, opts ...grpc.CallOption) (*SurveyEvidence, error) {
	...
	err := c.cc.Invoke(ctx, SurveyService_UploadSurveyEvidence_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *surveyServiceClient) GetSurveyTemplate(ctx context.Context, in *GetSurveyTemplateRequest, opts ...grpc.CallOption) (*SurveyTemplate, error) {
	out := new(SurveyTemplate)
	err := c.cc.Invoke(ctx, SurveyService_GetSurveyTemplate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *surveyServiceClient) ListSurveyTemplates(ctx context.Context, in *ListSurveyTemplatesRequest, opts ...grpc.CallOption) (*ListSurveyTemplatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, SurveyService_ListSurveyTemplates_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *surveyServiceClient) CreateSurveyTemplate(ctx context.Context, in *CreateSurveyTemplateRequest, opts ...grpc.CallOption) (*SurveyTemplate, error) {
	out := new(SurveyTemplate)
	err := c.cc.Invoke(ctx, SurveyService_CreateSurveyTemplate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSurveyServiceServer) ListSurveysByApplication(context.Context, *ListSurveysByApplicationRequest) (*ListSurveysByApplicationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListSurveysByApplication not implemented")
}
...
func (UnimplementedSurveyServiceServer) VerifySurvey(context.Context, *VerifySurveyRequest) (*ApplicationSurvey, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VerifySurvey not implemented")
}
func (UnimplementedSurveyServiceServer) SubmitSurveyAnswer(context.Context, *SubmitSurveyAnswerRequest) (*SurveyAnswer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitSurveyAnswer not implemented")
}
func (UnimplementedSurveyServiceServer) UploadSurveyEvidence(context.Context, *UploadSurveyEvidenceRequest) (*SurveyEvidence, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UploadSurveyEvidence not implemented")
}
func (UnimplementedSurveyServiceServer) GetSurveyTemplate(context.Context, *GetSurveyTemplateRequest) (*SurveyTemplate, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSurveyTemplate not implemented")
}
...
func (UnimplementedSurveyServiceServer) CreateSurveyTemplate(context.Context, *CreateSurveyTemplateRequest) (*SurveyTemplate, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateSurveyTemplate not implemented")
}
...
func _SurveyService_GetSurveyTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSurveyTemplateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SurveyServiceServer).GetSurveyTemplate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SurveyService_GetSurveyTemplate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SurveyServiceServer).GetSurveyTemplate(ctx, req.(*GetSurveyTemplateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SurveyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSurveyTemplate",
			Handler:    _SurveyService_GetSurveyTemplate_Handler,
		},
		{
